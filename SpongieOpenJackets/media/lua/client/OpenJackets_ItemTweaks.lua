...
-- shirt ripped
AddNewExtraItem("Shirt_DenimVest", "Shirt_DenimVestOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Shirt_LumberjackVest", "Shirt_LumberjackVestOPEN", "CloseJacket", "OpenJacket", 0.75);


-- hunting vests
AddNewExtraItem("Base.Vest_HighViz", "Vest_HighVizOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Foreman", "Vest_ForemanOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Hunting_CamoGreen", "Vest_Hunting_CamoGreenOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Hunting_Camo", "Vest_Hunting_CamoOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Hunting_Orange", "Vest_Hunting_OrangeOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Hunting_Grey", "Vest_Hunting_GreyOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Waistcoat_GigaMart", "Vest_Waistcoat_GigaMartOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_WaistcoatTINT", "Vest_WaistcoatTINTOPEN", "CloseJacket", "OpenJacket", 0.75);
AddNewExtraItem("Base.Vest_Waistcoat", "Vest_WaistcoatOPEN", "CloseJacket", "OpenJacket", 0.75);