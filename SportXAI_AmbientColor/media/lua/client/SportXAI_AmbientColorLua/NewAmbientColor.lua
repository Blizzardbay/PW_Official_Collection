...
local function Sunshine()
	...
	UIManager.DrawTexture(sunshineE_Tex, 0, 0, screenWidth, screenHeight, sunshineE_Alpha - intensityTable[1] - intensityTable[2] - intensityTable[3])
	UIManager.DrawTexture(sunshineW_Tex, 0, 0, screenWidth, screenHeight, sunshineW_Alpha - intensityTable[1] - intensityTable[2] - intensityTable[3])
end
Events.OnPostUIDraw.Add(Sunshine)
