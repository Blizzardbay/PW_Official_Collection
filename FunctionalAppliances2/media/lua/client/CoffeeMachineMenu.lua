...
FACoffeeMachine.doBuildMenu = function(player, menu, square, CoffeeMachine)
	...
	for i=0, playerItems:size()-1 do
		...
		if item.getFoodType and item:getFoodType() and item:getFoodType() == "Milk" then
			milkItem = item	
		end
	...
	if groupName == "Espresso" then
		...
		subContext1:addOption(FA.translation.coffeebeans,
				  ...
				  CoffeeMachine,
				  "grind", soundFileGrinding, nil, nil, nil)
		...
		subContext1:addOption(FA.translation.bagofcoffeebeans,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "grindbag", soundFileGrinding, nil, nil, nil)
	end
	...
	if teacup then
		subContext2:addOption(FA.translation.teacup,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "tea", soundFileBoiling, teacup, waterItem, nil)
	end
	if mugCyan then
		subContext2:addOption(FA.translation.cyanmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "tea", soundFileBoiling, mugCyan, waterItem, nil)
	end
	if mugRed then
		subContext2:addOption(FA.translation.redmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "tea", soundFileBoiling, mugRed, waterItem, nil)
	end
	if mugWhite then
		subContext2:addOption(FA.translation.whitemug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "tea", soundFileBoiling, mugWhite, waterItem, nil)
	end
	if mugSpiffo then
		subContext2:addOption(FA.translation.spiffomug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "tea", soundFileBoiling, mugSpiffo, waterItem, nil)
	end
	...
	if mugCyan then
		subContext3:addOption(FA.translation.cyanmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "instantcoffee", soundFileBoiling, mugCyan, waterItem, nil)
	end
	if mugRed then
		subContext3:addOption(FA.translation.redmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "instantcoffee", soundFileBoiling, mugRed, waterItem, nil)
	end
	if mugWhite then
		subContext3:addOption(FA.translation.whitemug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "instantcoffee", soundFileBoiling, mugWhite, waterItem, nil)
	end
	if mugSpiffo then
		subContext3:addOption(FA.translation.spiffomug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "instantcoffee", soundFileBoiling, mugSpiffo, waterItem, nil)
	end
	if thermos then
		subContext3:addOption(FA.translation.thermos,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "instantcoffee", soundFileBoiling, thermos, waterItem, nil)
	end
	if lowball then
		subContext3:addOption(FA.translation.lowballglass,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "instantcoffee", soundFileBoiling, lowball, waterItem, nil)
	end
	...
	if mugCyan then
		subContext4:addOption(FA.translation.cyanmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "coffee", soundFileBrewing, mugCyan, waterItem, nil)
	end
	if mugRed then
		subContext4:addOption(FA.translation.redmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "coffee", soundFileBrewing, mugRed, waterItem, nil)
	end
	if mugWhite then
		subContext4:addOption(FA.translation.whitemug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "coffee", soundFileBrewing, mugWhite, waterItem, nil)
	end
	if mugSpiffo then
		subContext4:addOption(FA.translation.spiffomug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "coffee", soundFileBrewing, mugSpiffo, waterItem, nil)
	end
	if thermos then
		subContext4:addOption(FA.translation.thermos,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "coffee", soundFileBrewing, thermos, waterItem, nil)
	end
	if lowball then
		subContext4:addOption(FA.translation.lowballglass,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "coffee", soundFileBrewing, lowball, waterItem, nil)
	end
	if not mugCyan and not mugRed and not mugWhite and not mugSpiffo and not thermos and not lowball then
	...
	if groupName == "Espresso" then
		...
		if teacup then
			subContext5:addOption(FA.translation.teacup,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "espresso", soundFileEspresso, teacup, waterItem, nil)
		end
		if mugCyan then
			subContext5:addOption(FA.translation.cyanmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "espresso", soundFileEspresso, mugCyan, waterItem, nil)
		end
		if mugRed then
			subContext5:addOption(FA.translation.redmug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "espresso", soundFileEspresso, mugRed, waterItem, nil)
		end
		if mugWhite then
			subContext5:addOption(FA.translation.whitemug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "espresso", soundFileEspresso, mugWhite, waterItem, nil)
		end
		if mugSpiffo then
			subContext5:addOption(FA.translation.spiffomug,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "espresso", soundFileEspresso, mugSpiffo, waterItem, nil)
		end
		if not teacup and not mugCyan and not mugRed and not mugWhite and not mugSpiffo then
		...
		menu:addOption(FA.translation.makelatte,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "latte", soundFileFrothing, espresso, waterItem, milkItem)
		...
		menu:addOption(FA.translation.makecappuccino,
				  ...
				  getSpecificPlayer(player),
				  CoffeeMachine,
				  "cappuccino", soundFileFrothing, espresso, waterItem, milkItem)
	end
end

FACoffeeMachine.onUseCoffeeMachine = function(junk, player, CoffeeMachine, MyChoice, soundFile, container, waterItem, milkItem)
	...
	if MyChoice == "latte" or MyChoice == "cappuccino" then 
		if container == nil and not milkItem then
		...
		elseif container == nil then
			...
			return
		elseif not milkItem then
			player:Say(FA.translation.sayneedmissingingredients .. " " .. FA.translation.milk)
			return
		end
	end

	ISTimedActionQueue.add(UseCoffeeMachine:new(player, machine, soundFile, MyChoice, container, waterItem, milkItem, squareToTurn))
end