...
local function theEnd(player, machine, coffeeChoice, drinkContainer, waterItem, milkItem)
...
function UseCoffeeMachine:perform()
	...
	theEnd(self.character, self.machine, self.coffeeChoice, self.drinkContainer, self.waterItem, self.milkItem)

	ISBaseTimedAction.perform(self)
end

function UseCoffeeMachine:new(character, machine, sound, coffee, container, water, milk)
	local o = {}
	setmetatable(o, self)
	self.__index = self
