...
erisPLL_nvg.onActivate = function(_, _plObj, _itemObj, _manager)
	...
	_plObj:getEmitter():playSound("nvON", true);  
...
erisPLL_nvg.init = function()
	...
	erisPLL_inventoryBar.registerItem("Base.Animask23", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	erisPLL_inventoryTooltip.registerItem("Base.Animask23", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	erisPLL_inventoryBar.registerItem("Base.Mask_HECU", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	erisPLL_inventoryTooltip.registerItem("Base.Mask_HECU", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
end
