...
--Coffee
SFFarmNewVeggies.growCoffee = function(planting, nextGrowing, updateNbOfGrow)
	local nbOfGrow = planting.nbOfGrow;
	local water = farming_vegetableconf.calcWater(planting.waterNeeded, planting.waterLvl);
	local diseaseLvl = farming_vegetableconf.calcDisease(planting.mildewLvl);
	if(nbOfGrow <= 0) then -- young
...
farming_vegetableconf.icons["Cauliflowers"] = "media/textures/Item_Cauliflower.png";
...
farming_vegetableconf.props["Coffee"].seedsRequired = 1;
farming_vegetableconf.props["Coffee"].texture = "sffarming_01_24";
farming_vegetableconf.props["Coffee"].waterLvl = 55;
farming_vegetableconf.props["Coffee"].timeToGrow = ZombRand(180, 260);
farming_vegetableconf.props["Coffee"].minVeg = 1;
farming_vegetableconf.props["Coffee"].maxVeg = 10;
farming_vegetableconf.props["Coffee"].minVegAutorized = 3;
farming_vegetableconf.props["Coffee"].maxVegAutorized = 18;
farming_vegetableconf.props["Coffee"].vegetableName = "filcher.CoffeeGrains";
farming_vegetableconf.props["Coffee"].seedName = "filcher.CoffeeSeed";
farming_vegetableconf.props["Coffee"].growCode = "SFFarmNewVeggies.growCoffee";
farming_vegetableconf.props["Coffee"].seedPerVeg = 1;
farming_vegetableconf.props["Coffee"].retainOnHarvest = 4;
...
farming_vegetableconf.props["Tea"].seedsRequired = 1;
