require 'Items/ProceduralDistributions'
	...
	table.insert(ProceduralDistributions["list"]["GunStoreShelf"].items, "ImprovisedSilencers.Silencer");
	table.insert(ProceduralDistributions["list"]["GunStoreShelf"].items, 3);
	table.insert(ProceduralDistributions["list"]["GunStoreCounter"].items, "ImprovisedSilencers.Silencer");
	table.insert(ProceduralDistributions["list"]["GunStoreCounter"].items, 6);
	table.insert(ProceduralDistributions["list"]["GunStoreDisplayCase"].items, "ImprovisedSilencers.Silencer");
	table.insert(ProceduralDistributions["list"]["GunStoreDisplayCase"].items, 7);
	table.insert(ProceduralDistributions["list"]["GunStoreMagazineRack"].items, "ImprovisedSilencers.Silencer");
