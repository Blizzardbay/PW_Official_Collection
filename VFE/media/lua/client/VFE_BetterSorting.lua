if getActivatedMods():contains("BetterSortCC") then
	...
	TweakItem("Base.FALClassic","DisplayCategory","WepFire");
	TweakItem("Base.AssaultRifleM1","DisplayCategory","WepFire");
	TweakItem("Base.Shotgun2","DisplayCategory","WepFire");
	TweakItem("Base.ShotgunSemi","DisplayCategory","WepFire");
	TweakItem("Base.ShotgunSemi2","DisplayCategory","WepFire");
	TweakItem("Base.ShotgunSawnoffNoStock","DisplayCategory","WepFire");
	TweakItem("Base.DoubleBarrelShotgunSawnoffNoStock","DisplayCategory","WepFire");
	TweakItem("Base.ShotgunSilent","DisplayCategory","WepFire");
	TweakItem("Base.AK47Unfolded","DisplayCategory","WepFire");
	TweakItem("Base.Mini14Unfolded","DisplayCategory","WepFire");
	TweakItem("Base.MP5Unfolded","DisplayCategory","WepFire");
	TweakItem("Base.MP5Folded","DisplayCategory","WepFire");
	...
	TweakItem("Base.SniperRifle","DisplayCategory","WepFire");
