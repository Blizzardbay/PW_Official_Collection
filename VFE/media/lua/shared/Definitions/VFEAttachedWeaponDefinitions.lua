...
table.insert(AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PrivateMilitia.weapons, AttachedWeaponDefinitions.shotgunPoliceVFE);
table.insert(AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PrivateMilitia.weapons, AttachedWeaponDefinitions.handgunHolsterVFE);
table.insert(AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PrivateMilitia.weapons, AttachedWeaponDefinitions.policeHeavyWeapon);
table.insert(AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PrivateMilitia.weapons, AttachedWeaponDefinitions.policeSuperWeapon);

--table.insert(AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PrisonGuard.weapons, AttachedWeaponDefinitions.handgunHolsterVFE);